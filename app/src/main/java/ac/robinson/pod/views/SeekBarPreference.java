...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
	...
	protected View onCreateView(ViewGroup parent) {
		...
		if (summary != null) {
			...
			if (summaryParent instanceof ViewGroup) {
				...
				layoutInflater.inflate(R.layout.preference_seek_bar, summaryParentGroup);
					...
					public boolean onTouch(View v, MotionEvent event) {
						switch (event.getAction()) {
							...
							case MotionEvent.ACTION_DOWN:
								...
								// intentionally not breaking/returning so we cancel if appropriate
							default:
								// because we can't change the action in the parent's onInterceptTouchEvent, we
								// dispatch
	...
	public void onClick(View v) {
		if (System.currentTimeMillis() - mDoubleTapTime < ViewConfiguration.getDoubleTapTimeout()) {
			...
			Toast.makeText(v.getContext(), R.string.preference_value_reset, Toast.LENGTH_SHORT).show();
		}
